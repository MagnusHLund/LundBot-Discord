...
namespace LundBot.Infrastructure.Persistence.Migrations
{
    ...
    public partial class MergedUpvoteAndInviteLeaderboards : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        LeaderboardScoreSourceId = table
        ...
        {
            migrationBuilder.DropTable(name: "LeaderboardScoreEntity");

            migrationBuilder.DropIndex(name: "leaderboards_index_3", table: "Leaderboards");
