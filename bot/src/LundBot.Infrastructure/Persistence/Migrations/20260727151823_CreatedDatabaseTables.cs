...
namespace LundBot.Infrastructure.Persistence.Migrations
{
    ...
    public partial class CreatedDatabaseTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        LeaderboardsId = table
                            .Column<uint>(type: "int unsigned", nullable: false)
                            .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                        DiscordServerId = table
                            .Column<string>(type: "char(19)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        DiscordChannelId = table
                            .Column<string>(type: "char(19)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        Title = table
                            .Column<string>(type: "varchar(64)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        Message = table
                            .Column<string>(type: "varchar(256)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        WebsiteTrafficId = table
                            .Column<uint>(type: "int unsigned", nullable: false)
                            .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                        HashedIp = table.Column<byte[]>(type: "binary(32)", nullable: false),
                        ClickedInviteButton = table.Column<bool>(
                            type: "tinyint(1)",
                            nullable: false,
                            defaultValue: false
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        WebsiteTrafficMessagesId = table
                            .Column<uint>(type: "int unsigned", nullable: false)
                            .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                        DiscordMessageId = table
                            .Column<string>(type: "char(19)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        CreatedAt = table.Column<DateTime>(
                            type: "datetime(3)",
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        UpdatedAt = table
                            .Column<DateTime>(type: "datetime(3)", nullable: false)
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        UpvotingLeaderboardId = table
                            .Column<uint>(type: "int unsigned", nullable: false)
                            .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                        LeaderboardsId = table.Column<uint>(type: "int unsigned", nullable: false),
                        DiscordUserIdVoter = table
                            .Column<string>(type: "char(19)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        DiscordUserIdTarget = table
                            .Column<string>(type: "char(19)", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        UpdatedAt = table
                            .Column<DateTime>(type: "datetime(3)", nullable: false)
            ...
            migrationBuilder.CreateIndex(name: "UniqueIp", table: "WebsiteTraffic", column: "HashedIp", unique: true);
        ...
        {
            migrationBuilder.DropTable(name: "LeaderboardMessages");

            migrationBuilder.DropTable(name: "LeaderboardScores");

            migrationBuilder.DropTable(name: "UpvotingLeaderBoard");

            migrationBuilder.DropTable(name: "WebsiteTraffic");

            migrationBuilder.DropTable(name: "WebsiteTrafficMessages");
